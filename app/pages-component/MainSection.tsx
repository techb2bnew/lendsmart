...
export default function MainSection({
  ...
  return (
    <section className={`relative opacity-100 px-4 lg:px-8 overflow-hidden ${sectionBgClassName}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] items-start gap-10 lg:gap-6">
          <div className="pt-6 lg:pt-10">
            ...
            {featurePoints && featurePoints.length > 0 && (
              <div className="mt-4 flex flex-wrap gap-x-5 gap-y-2">
                {featurePoints.map((point) => (
                  <p key={point} className="inline-flex items-center text-[12px] font-medium text-[#2e2e2e]">
                    {featurePointIcon ? (
            ...
            <div className="mt-6 flex flex-wrap items-center gap-4">
              ...
              >
                {callIcon}
                <span className="text-[14px] font-semibold">{callText}</span>
              </a>
              ...
              >
                <Image src="/icon.png" alt="Whatsapp" width={30} height={30} priority className="object-contain" />
                <span>{chatText}</span>
              </a>
            </div>
          </div>
          ...
          <div className="relative flex justify-center lg:justify-end lg:pr-8 z-10">
            <div className="relative h-[250px] w-full max-w-[300px] sm:h-[290px] sm:max-w-[350px] lg:h-[400px] lg:max-w-[500px] overflow-hidden rounded-[16px]">
              <Image src={image} alt="About hero" fill priority className="object-contain" />
            </div>
          </div>
        </div>
      </div>
