...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative opacity-100 bg-white px-4 lg:px-8 overflow-hidden">
      ...
      {/* Mobile Background Image - only visible on mobile, behind all content */}
      ...
      {/* top content area */}
      <div className="max-w-[1440px] mx-auto pt-0  lg:pt-16 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-[1.05fr_0.95fr] items-start gap-10 lg:gap-6">
          ...
          <div className="py-10 lg:py-10 md:text-[#222222] text-white">
            ...
            <p data-aos="fade-up" className="mt-4 text-[14px] leading-6 md:text-[#333333] text-white/90">
              We make the loan process simple, transparent, and tailored to your needs.
            </p>
 
            <div data-aos="fade-up" className="mt-6 flex flex-wrap items-center gap-4">
              <a
              ...
              <a
                href="https://wa.me/+61 413 206 624"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 border-b md:border-[#cfcfcf] border-white/50 pb-1 text-[14px] font-semibold md:text-black text-white hover:text-[#0479c3] transition">
                <Image
                  src="/icon.png"
                  alt="Whatsapp"
                  width={30}
      ...
      {/* Full-bleed mint band - hidden on mobile since background is already there */}
      <div className="relative z-10 mt-[-40px] md:mt-[-10px] lg:mt-[-60px] w-screen max-w-[100vw] left-1/2 -translate-x-1/2 pb-10 lg:pb-14 hidden md:block">
